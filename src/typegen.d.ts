...
export type ConfigNames = 'eslint/builtin' | 'sj-distributor/ignores' | '@eslint/js/recommended' | 'sj-distributor/typescript/setup' | 'sj-distributor/typescript/parser' | 'sj-distributor/typescript/rules' | 'sj-distributor/react/setup' | 'sj-distributor/react/rules' | 'sj-distributor/stylistic' | 'sj-distributor/unicorn'
