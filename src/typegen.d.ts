...
export type ConfigNames = 'eslint/builtin' | 'sj-distributor/ignores' | '@eslint/js/recommended' | 'sj-distributor/typescript/setup' | 'sj-distributor/typescript/parser' | 'sj-distributor/typescript/rules' | 'sj-distributor/react/recommended' | 'sj-distributor/react/recommended-typescript' | 'sj-distributor/react/hooks' | 'sj-distributor/react/refresh' | 'sj-distributor/stylistic' | 'sj-distributor/unicorn'
