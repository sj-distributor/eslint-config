...
export type ConfigNames = 'eslint/builtin' | 'sj-distributor/ignores' | 'sj-distributor/javascript/rules' | 'typescript-eslint/base' | 'typescript-eslint/eslint-recommended' | 'typescript-eslint/recommended' | 'sj-distributor/react/recommended' | 'sj-distributor/react/recommended-typescript' | 'sj-distributor/react/hooks' | 'sj-distributor/react/refresh' | 'sj-distributor/stylistic' | 'sj-distributor/unicorn'
